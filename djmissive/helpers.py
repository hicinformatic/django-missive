...
def _normalize_providers_config() -> Optional[list[str]]:
    """
    Normalize `settings.MISSIVE_PROVIDERS` into a list of pymissive paths.
...
def discover_providers():
    ...
    for file_path in providers_dir.glob("*.py"):
        ...
        try:
            ...
            module = importlib.import_module(f"djdjmissive.providers.{module_name}")
            ...
            for name, obj in inspect.getmembers(module, inspect.isclass):
                ...
                if (
                    ...
                    and obj.__module__ == f"djdjmissive.providers.{module_name}"
                ):
